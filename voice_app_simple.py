...
def main():
    ...
    with col1:
        ...
        uploaded_file = st.file_uploader(
            ...
            help="Record your voice using your phone or computer, then upload the file here"
        )
        ...
        if uploaded_file is not None:
            ...
            with st.spinner("Processing your voice..."):
                bot_response = process_voice_input(audio_bytes)
        ...
        st.write("**Option 2: Type Your Message**")
        
        user_text_input = st.text_input("Type your message here:")
        
        if user_text_input and st.button("Send Message"):
        ...
        st.markdown("""
        **For Voice Input:**
        1. Record your voice using your phone or computer
        2. Save as WAV, MP3, M4A, or OGG format
        3. Upload the file using the file uploader above
    ...
    with col2:
        ...
        if st.session_state.conversation_history:
            ...
            st.write("No conversation yet. Upload an audio file or type a message to start!")
